...
// Builds a fresh pg-mem instance with 0001 + 0002 applied, then wraps its
// pg-compatible Pool in the same PgDbClient used in production. This exercises
// the real query and pinned-connection transaction behavior rather than a
// hand-rolled DbClient mock.
